...
/**
 * Command line script to call all unit tests of the sysmanager extension
...
class SysmanagerTests {
	...
	public static function suite() {
		...
		$testClasses= TodoyuUnittestManager::getExtensionTestClasses('sysmanager', true);
